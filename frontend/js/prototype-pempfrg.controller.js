var app = angular.module('DashboardApp');
  ...
  app.controller('DashboardController', function($scope, $timeout, $q, ApiService, AuthService) {
    ...
    var dashboardDomain = window.location.pathname.toLowerCase().indexOf('farmacia') !== -1 ? 'farmacia'
      : window.location.pathname.toLowerCase().indexOf('centrocirurgico') !== -1 ? 'centrocirurgico'
      : window.location.pathname.toLowerCase().indexOf('fisioterapia') !== -1 ? 'fisioterapia' : 'medico';
    var DIMENSOES_VALIDAS = {
      medico: ['convenio', 'setor', 'medico_executor', 'procedimento'],
      farmacia: ['estabelecimento', 'setor', 'tipo_convenio', 'convenio'],
      centrocirurgico: ['procedimentos', 'convenio', 'setor', 'tipo_convenio', 'tipo_atendimento', 'medico_executor'],
      fisioterapia: ['procedimentos', 'convenio', 'setor', 'tipo_convenio', 'medico_executor']
    }[dashboardDomain];
    var INDICADORES_VALIDOS = {
      medico: ['todos', 'qtd_contas', 'qtd_procedimentos', 'valor_produzido', 'valor_medico'],
      farmacia: ['todos', 'qtd_contas', 'qtd_procedimentos', 'qtd_matmed'],
      centrocirurgico: ['todos', 'qtd_contas', 'qtd_procedimentos', 'valor_produzido'],
      fisioterapia: ['todos', 'qtd_contas', 'qtd_procedimentos', 'valor_produzido', 'valor_medico']
    }[dashboardDomain];
