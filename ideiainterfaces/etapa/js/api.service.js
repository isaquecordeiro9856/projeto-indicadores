...
(function (angular) {
  ...
  app.factory('ApiService', function($q, $timeout, $http) {
    ...
    var ENDPOINT = '/api/hospital/etapa-permanencia';
    ...
    const configIndicadores = {
      ...
      dias_alta:   { nome: 'Dias Alta',   isMoeda: false, isPercentual: false, isDecimal: false, baseMin: 120, baseMax: 1800, color: '#0284c7', badgeClass: 'badge-dias-alta' },
      media_alta:  { nome: 'Média Alta',  isMoeda: false, isPercentual: false, isDecimal: true,  baseMin: 3.5, baseMax: 16.0, color: '#d97706', badgeClass: 'badge-media-alta' }
    };
